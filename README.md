# postEoR
postEoR is a semi-numerical post-processing pipeline that builds off of [21cmFAST](https://github.com/21cmfast/21cmFAST) to model the neutral hydrogen field from $3 \lesssim z \lesssim 7$. This enables efficient simulation of the transition from the end of reionization to late-time large-scale structure formation. 
